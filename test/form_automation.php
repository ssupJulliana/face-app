...
<body>
	...
	<!-- basta meron pang kulang na code dyan. hindi pa nakapasok sa mismong button yung icon -->
	<button type="submit" class="btn btn-primary"><i class="bi bi-cloud-arrow-up"></i>Process</button>
...
<script type="text/javascript" href="js/jquery-migrate-3.5.0.js"></script>
